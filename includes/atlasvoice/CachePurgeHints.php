...
/**
 * AtlasVoice Cache Purge Hints (TTS-238 C4a, v5 §14.1 refactor).
 *
 ...
 * side effects.
 *
 * Isolation note (P1/P4): namespace TTA\AtlasVoice — no dependency on any
 * TTA\ legacy class. Module is delete-safe.
 */
class CachePurgeHints {
