            ...
            <Row className="tta_player-controls-row g-3">
                    ...
                    <Form.Group className="tta_player-form-group">
                        <Form.Label htmlFor='id' className="tta_player-label">
                            ...
                            <OverlayTrigger
                                ...
                                <a className='tta_youtube-link' target='_blank'
                ...
                <Col md={4}>
                    <Form.Group className="tta_player-form-group">
                        ...
                        {
                            listeningBtnStyle?.buttonSettings?.display_player_to && Object.keys(userRoles).length && 
                            <MultiSelect 
                                toastMessage={'Player display restriction to multiple user type is available in the pro version'}
                            ...
                            <Form.Group className="tta_player-form-group">
                                <Form.Label className="tta_player-label">
                                    ...
                                    <OverlayTrigger
                                        ...
                                        <Button variant="link" className='tta_question-icon'>?</Button>
                                    </OverlayTrigger>
                                </Form.Label>
                                <Form.Control
                                    type='date'
