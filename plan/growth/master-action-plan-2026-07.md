...
| 24b | **Fix self-inflicted facts AI now repeats**: homepage meta says "2,000+ websites" vs wp.org's 4,000+ active installs; language/voice counts inconsistent across own pages (51+/63/81+/300+); pricing page still shows the Black Friday 2025 promo (`FSBFCM2025`) in July 2026. Also document audio schema on the FREE tier — new rival TTSWP is beating us on discovery prompts purely on that claim — and seed the Capterra listing (0 reviews, now a load-bearing citation) | #24 recheck | hours | ☐ todo |
