...
> **⚠ CORRECTION (2026-07-15):** §3's "July surge = real new users" conclusion is **withdrawn**.
> Follow-up investigation proved the surge is a **tracking artifact** (existing sites re-firing
> events; 80% of "new" emails exist in older exports; old plugin versions on surge sites; flat
> wp.org downloads). See `plan/growth/surge-source-findings-2026-07.md`. The rest of this document
> (the 2023–2026 decline trend, the 2024 cliff, rebrand timeline) stands.

> Source: `plan/data/2026-07/tracker-2026-07-11/tracking.csv` — 5,532 consented installs of the TTS product
