 ...
 */
var _TextToSpeechProPlayer_brand = /*#__PURE__*/new WeakSet();
var TextToSpeechProPlayer = /*#__PURE__*/_createClass(function TextToSpeechProPlayer(buttonId) {
  ...
  _classPrivateMethodInitSpec(this, _TextToSpeechProPlayer_brand);
  _defineProperty(this, "buttonId", void 0);
  _defineProperty(this, "title", '');
  _defineProperty(this, "contents", '');
  _defineProperty(this, "path", '');
  this.buttonId = buttonId;
  _assertClassBrand(_TextToSpeechProPlayer_brand, this, _setTitle).call(this, TTS);
  _assertClassBrand(_TextToSpeechProPlayer_brand, this, _setPath).call(this, TTS);
  this.content = content;
  var demo_file = '/admin/demos/player3/demo.mp3';
  _assertClassBrand(_TextToSpeechProPlayer_brand, this, _setUpPlayer).call(this, ttsObj.plugin_url + demo_file);
  if (this.buttonId == 4) {
    demo_file = 'https://cloud.google.com/text-to-speech/docs/audio/en-GB-Chirp-HD-F.wav';
    _assertClassBrand(_TextToSpeechProPlayer_brand, this, _setUpPlayer).call(this, demo_file, 1);
  }
  if (this.buttonId == 5) {
  ...
  if (this.buttonId == 6) {
    ...
    _assertClassBrand(_TextToSpeechProPlayer_brand, this, _setUpPlayer).call(this, ttsObj.plugin_url + demo_file, 1);
  }
});
function _setPath(tts) {
  if (tts !== null && tts !== void 0 && tts.extra) {
    this.path = tts.extra[this.buttonId].date;
  }
}
function _setTitle(tts) {
  if (tts !== null && tts !== void 0 && tts.extra) {
