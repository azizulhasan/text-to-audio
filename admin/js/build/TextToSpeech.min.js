...
var getButtonContent = function getButtonContent(buttonId, cssClass, isProLicenseActive) {
  return wp.hooks.applyFilters('tts_play_button_content', "<button id=\"tts__listent_content_".concat(buttonId, "\" class=\"tts__listent_content  ").concat(cssClass, "\" type=\"button\" title=\"Text To Audio:  Tap to listen post.\"><div class=\"tts_button\"><span class=\"dashicons dashicons-controls-play\"></span><span>Listen<span></div> </button>"), isProLicenseActive);
};
...
var TextToSpeech = /*#__PURE__*/function () {
  function TextToSpeech(buttonId, content, button) {
    ...
    value: function speak(speech) {
      ...
      speech.speak({
        ...
        if (!_this.speech.speaking()) {
          ...
          _this.speakButton.innerHTML = _this.replayButtonContent();
          _this.speakButton.setAttribute('title', 'Text To Audio : ' + _this.replayButtonText());
