...
// addFilter should be always before of applyFilters.
// wp.hooks.addFilter('add_menu_to_text_to_audio', 'text-to-audio', function (name) {
//     name.push('fuzail')
//     return name;
// }, 10)
...
// let data = wp.hooks.applyFilters('add_menu_to_text_to_audio', ['hasan', 'kalam'])
...
// wp.hooks.addAction('add_menu_to_text_test', 'text-to-audio_action', function () {
//     console.log('action')
...
wp.hooks.addFilter('tta_has_pro', 'text-to-audio', function () {
    return true;
}, 10)
