...
/* harmony export */   pricingPageUrl: () => (/* binding */ pricingPageUrl),
/* harmony export */   proUrl: () => (/* binding */ proUrl)
/* harmony export */ });
/**
...
var cfg = typeof window !== 'undefined' && (window.tta_obj && window.tta_obj.pro || window.ttsWizardData && window.ttsWizardData.pro || window.ttsObj && window.ttsObj.pro) || {};
var BASES = cfg.bases || {
 ...
 * @returns {string}
 */
var proUrl = function proUrl() {
  var content = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'pricing';
  var base = BASES[page] || BASES.pricing;
 ...
 * @returns {string}
 */
var pricingPageUrl = function pricingPageUrl() {
  var content = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  var o = typeof window !== 'undefined' && (window.tta_obj || window.ttsObj || window.ttsWizardData) || {};
  return o.pricing_url || proUrl(content, 'pricing');
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (proUrl);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _src_dashboard_proUrl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/dashboard/proUrl */ "./src/dashboard/proUrl.js");
...
var AtlasVoicePlayerInsights = /*#__PURE__*/function () {
  function AtlasVoicePlayerInsights(searchParams) {
    ...
    _defineProperty(this, "proPage", (0,_src_dashboard_proUrl__WEBPACK_IMPORTED_MODULE_0__.proUrl)('player_insights'));
  ...
  return _createClass(AtlasVoicePlayerInsights, [{
    ...
    value: function () {
      var _getInsights = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        var params, query, url, response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              url = query ? this.apiUrl + (this.apiUrl.includes('?') ? '&' : '?') + query : this.apiUrl;
              _context.next = 10;
              return fetch(url, {
                method: 'GET',
                headers: {
    ...
    value: function shouldTrackAnalyticsData() {
      var _window2, _window3, _this$searchParams$po, _this$searchParams4;
      ...
      var trackableIds = (_window3 = window) === null || _window3 === void 0 || (_window3 = _window3.ttsObj) === null || _window3 === void 0 || (_window3 = _window3.settings) === null || _window3 === void 0 || (_window3 = _window3.analytics) === null || _window3 === void 0 ? void 0 : _window3.tts_trackable_post_ids;

      // No explicit list configured → every post is trackable.
      if (!(trackableIds !== null && trackableIds !== void 0 && trackableIds.length)) {
        return true;
      }
      ...
      var ids = trackableIds.map(function (id) {
        return String(id);
      });
      var postId = String((_this$searchParams$po = (_this$searchParams4 = this.searchParams) === null || _this$searchParams4 === void 0 ? void 0 : _this$searchParams4.post_id) !== null && _this$searchParams$po !== void 0 ? _this$searchParams$po : "");
 ...
 */
if ((_window4 = window) !== null && _window4 !== void 0 && (_window4 = _window4.ttsObj) !== null && _window4 !== void 0 && _window4.is_atlasvoice_addon_functional) {
  window.AtlasVoicePlayerInsights = AtlasVoicePlayerInsights;
}
if ((_window5 = window) !== null && _window5 !== void 0 && (_window5 = _window5.ttsObj) !== null && _window5 !== void 0 && _window5.is_admin_page) {
