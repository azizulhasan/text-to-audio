...
var AtlasVoiceAnalytics = /*#__PURE__*/function () {
  ...
  _createClass(AtlasVoiceAnalytics, [{
  ...
  _createClass(TextToSpeech, [{
    ...
    value: function pauseButtonContent() {
      ...
      if ((_ttsObj6 = ttsObj) !== null && _ttsObj6 !== void 0 && (_ttsObj6 = _ttsObj6.player_customizations) !== null && _ttsObj6 !== void 0 && (_ttsObj6 = _ttsObj6[1]) !== null && _ttsObj6 !== void 0 && _ttsObj6.pause) {
        ...
        icon = "<div className=\"tts_button\">".concat(_document3.documentElement.outerHTML, "<span>");
      }
    ...
    value: function displayButtonText(listenStatus) {
      ...
      if ((this === null || this === void 0 ? void 0 : this.playButtonNo) == 1 && this !== null && this !== void 0 && (_this$speakButton = this.speakButton) !== null && _this$speakButton !== void 0 && _this$speakButton.innerHTML) {
        if ('listen' === listenStatus) {
          ...
          this.setButtonInnerContent(this.pauseButtonContent(), _buttonHoverTitle);
    ...
    key: "setButtonInnerContent",
    value: function setButtonInnerContent(content, buttonHoverTitle) {
      this.speakButton.removeChild(this.speakButton.children[0]); // remove first
      this.speakButton.removeChild(this.speakButton.children[0]); // remove (new) first, originally second
    ...
    value: function _prepareSpeakButton(speech) {
      ...
      document.addEventListener("visibilitychange", function () {
        var _window$ttsObj$settin, _window4;
        ...
        var stop_autopause = (_window$ttsObj$settin = (_window4 = window) === null || _window4 === void 0 || (_window4 = _window4.ttsObj) === null || _window4 === void 0 || (_window4 = _window4.settings) === null || _window4 === void 0 || (_window4 = _window4.settings) === null || _window4 === void 0 ? void 0 : _window4.tta__settings_stop_auto_pause_after_switching_tab) !== null && _window$ttsObj$settin !== void 0 ? _window$ttsObj$settin : false;
        ...
        if ('visible' === document.visibilityState && _this4.listenStatus === 'resume' && !stop_autopause) {
          var _window$ttsObj$settin2, _window5;
          var isPausedByIntention = JSON.parse(window.sessionStorage.getItem('tts_paused_by_intention'));
          var stop_autoplay = (_window$ttsObj$settin2 = (_window5 = window) === null || _window5 === void 0 || (_window5 = _window5.ttsObj) === null || _window5 === void 0 || (_window5 = _window5.settings) === null || _window5 === void 0 || (_window5 = _window5.settings) === null || _window5 === void 0 ? void 0 : _window5.tta__settings_stop_auto_playing_after_switching_tab) !== null && _window$ttsObj$settin2 !== void 0 ? _window$ttsObj$settin2 : false;
...
if ((_window6 = window) !== null && _window6 !== void 0 && (_window6 = _window6.ttsObj) !== null && _window6 !== void 0 && _window6.is_pro_active) {
            ...
            try {
              ...
              switch (i(r) && u(r), n.state) {
                case "running":
                  ...
                  break;
                case "suspended":
                  document.hidden || d++, s && d >= e ? l(J("suspended")) : setTimeout(v, t);
              }
            } catch (o) {
              l(o);
            }
...
var BrowserSupport = /*#__PURE__*/function () {
  function BrowserSupport(ttsObj, voices, _selectedLang2, selectedVoice) {
    ...
    if (selectedVoice) {
      _classPrivateFieldSet(this, _selectedVoice, selectedVoice);
    }
  ...
  _createClass(BrowserSupport, [{
      ...
      if (this.voices.length) {
        Object.values(this.voices).map(function (voice) {
          ...
          if (matches !== null && voice.name) {
            _classPrivateFieldSet(_this, _lang, voice.lang);
            isSupported = true;
          }
        });
        return {
          lang: _classPrivateFieldGet(this, _lang),
    ...
    value: function setVoice(voice) {
      _classPrivateFieldSet(this, _voice, voice);
    }
  }, {
    ...
    value: function defineVoiceAndLang(voice, lang) {
      ...
      if (filteredVoices.length > 1) {
        ...
        _classPrivateFieldSet(this, _voice, voice);
        _classPrivateFieldSet(this, _lang, lang);
      }
    }
  }, {
    key: "getVoices",
    ...
    value: function validateCountryCode(countryCode) {
      ...
      for (var j = 0; j < voices.length; j++) {
        ...
        currentCountryCode = _classPrivateMethodGet(this, _getCountryCode, _getCountryCode2).call(this, currentCountryCode);
...
/* harmony export */   getFilteredVoices: () => (/* binding */ getFilteredVoices),
/* harmony export */   isString: () => (/* binding */ isString),
/* harmony export */   splitSentences: () => (/* binding */ splitSentences),
/* harmony export */   trim: () => (/* binding */ trim)
/* harmony export */ });
...
var getButtonContent = function getButtonContent(buttonId, cssClass, isProLicenseActive) {
  ...
  if ((_window4 = window) !== null && _window4 !== void 0 && (_window4 = _window4.ttsObj) !== null && _window4 !== void 0 && (_window4 = _window4.player_customizations) !== null && _window4 !== void 0 && (_window4 = _window4[1]) !== null && _window4 !== void 0 && _window4.play) {
    ...
    var icon = "<button id=\"tts__listent_content_".concat(buttonId, "\" class=\"tts__listent_content  ").concat(cssClass, "\" type=\"button\" title=\"").concat(buttonHoverTitle, "\"><div class=\"tts_button\">").concat(document.documentElement.outerHTML, "</div> <span>");
    icon += buttonText + '<span></span></span>';
    icon += "<select style=\"display:none;\" id=".concat('tts_current_player_voices_' + buttonId, " ></select>\n        ");
    return icon + '</div>';
  }
 ...
 * @returns 
 */
var getCountryCode = function getCountryCode(selectedLang) {
  if (selectedLang && selectedLang.indexOf('-') !== -1) {
    return selectedLang.split('-')[0];
  }
  if (selectedLang && selectedLang.indexOf('_') !== -1) {
...
* @returns 
*/
var getFilteredVoices = function getFilteredVoices(langCountryCode) {
  var voices = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var filteredVoices = [];
  if (voices.length < 1) {
    voices = window.speechSynthesis.getVoices();
  }
  Object.values(voices).map(function (voice) {
    var regex = new RegExp(langCountryCode, "gi");
    var matches = voice.lang.match(regex);
    if (matches !== null && voice.name) {
...
var TTSPlayButton = /*#__PURE__*/function (_HTMLElement) {
  ...
  function TTSPlayButton() {
    ...
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _htmlDecode);
    _defineProperty(_assertThisInitialized(_this), "speech", null);
    _defineProperty(_assertThisInitialized(_this), "isProLicenseActive", false);
    _defineProperty(_assertThisInitialized(_this), "analytics", null);
    if (typeof NoSleep === 'function' && (_ttsObj = ttsObj) !== null && _ttsObj !== void 0 && _ttsObj.is_mobile) {
      var noSleep = new NoSleep();
      window.onload = function () {
        noSleep.enable();
    ...
    if (window.hasOwnProperty('TTS')) {
      ...
      var _loop = function _loop() {
        ...
        if (buttonId == _this.getAttribute('data-id')) {
          ...
          var speechClass = _assertThisInitialized(_this);
          ...
          _this.getVoiceOptions(wrapper, buttonId, window.TTS.settings.listening.tta__listening_lang);
          ...
          if (settings !== null && settings !== void 0 && settings.customCSS) {
            style.textContent += "\n                            ".concat(_classPrivateMethodGet(_assertThisInitialized(_this), _htmlDecode, _htmlDecode2).call(_assertThisInitialized(_this), settings.customCSS), "\n                        ");
          }
  ...
  _createClass(TTSPlayButton, [{
    ...
    key: "getVoiceOptions",
    value: function getVoiceOptions(wrapper, buttonId, langCode) {
      var countryCode = (0,_tts_utilities_js__WEBPACK_IMPORTED_MODULE_1__.getCountryCode)(langCode);
      var filteredVoices = (0,_tts_utilities_js__WEBPACK_IMPORTED_MODULE_1__.getFilteredVoices)(countryCode);
...
function _htmlDecode2(str) {
  var txt = document.createElement("textarea");
  txt.innerHTML = str;
  return txt.value;
}
document.addEventListener('DOMContentLoaded', function () {
  var setVoices = setInterval(function () {
    if (window.speechSynthesis.getVoices().length) {
      clearInterval(setVoices);
      setVoices = null;
      console.log(window.speechSynthesis.getVoices());
