...
var TTSPlayButton = /*#__PURE__*/function (_HTMLElement) {
  ...
  return _createClass(TTSPlayButton, [{
    ...
    value: function initOldPlayer(shadow, buttonId, contents, settings) {
      ...
      style.textContent = "\n            /* TTS-241 \u2014 suppress focus outline on the custom-element host\n               (right-click / contextmenu would otherwise paint a thin\n               rectangle around the wrapper that reads as a border). */\n            :host(:focus), :host(:focus-visible), :host(:focus-within) {\n                outline: none !important;\n                box-shadow: none !important;\n            }\n            #tts__listent_content_".concat(buttonId, ".tts__listent_content{ ").concat(settings.btnStyle, " box-sizing: border-box; transition: all 0.5s ease-in-out; }\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content:hover{ ").concat(settings.btnStyle, " box-sizing: border-box; background-color:").concat(((_ttsObj2 = ttsObj) === null || _ttsObj2 === void 0 || (_ttsObj2 = _ttsObj2.settings) === null || _ttsObj2 === void 0 || (_ttsObj2 = _ttsObj2.customize) === null || _ttsObj2 === void 0 ? void 0 : _ttsObj2.hoverBackgroundColor) || '#f0f0f0', ";}\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content .tts_button{ display: inline-flex; align-items: center; gap: 8px; }\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content .tts_button_label{ display: inline-block; }\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content svg{ display:").concat(settings.shouldDisplayIcon, "; flex: 0 0 auto; }\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content:hover svg{ display:").concat(settings.shouldDisplayIcon, "; flex: 0 0 auto; }\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content:hover .tts_button_label{ color: ").concat(((_ttsObj3 = ttsObj) === null || _ttsObj3 === void 0 || (_ttsObj3 = _ttsObj3.settings) === null || _ttsObj3 === void 0 || (_ttsObj3 = _ttsObj3.customize) === null || _ttsObj3 === void 0 ? void 0 : _ttsObj3.hoverTextColor) || "#000000", " }\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content:focus,\n            #tts__listent_content_").concat(buttonId, ".tts__listent_content:focus-visible{ outline: none; box-shadow: none; }\n        ");
    ...
    value: function getNewButtonContent(buttonId, settings, status) {
      var _ttsObj5, _window6, _window7;
      ...
      var playerId = ((_window6 = window) === null || _window6 === void 0 || (_window6 = _window6.ttsObj) === null || _window6 === void 0 ? void 0 : _window6.player_id) || 1;
      var players = ((_window7 = window) === null || _window7 === void 0 || (_window7 = _window7.ttsObj) === null || _window7 === void 0 || (_window7 = _window7.buttonTextArr) === null || _window7 === void 0 ? void 0 : _window7.players) || {};
      ...
      var resolveText = function resolveText(s, flatKey, fallback) {
        ...
        return ((_window8 = window) === null || _window8 === void 0 || (_window8 = _window8.ttsObj) === null || _window8 === void 0 || (_window8 = _window8.buttonTextArr) === null || _window8 === void 0 ? void 0 : _window8[flatKey]) || fallback;
      };
      var resolveHover = function resolveHover(s, flatKey, fallback) {
        var _window9;
        var ps = stateForPlayer(s);
        if (ps && ps.hover) return 'Text To Audio : ' + ps.hover;
        var flat = (_window9 = window) === null || _window9 === void 0 || (_window9 = _window9.ttsObj) === null || _window9 === void 0 || (_window9 = _window9.buttonTextArr) === null || _window9 === void 0 ? void 0 : _window9[flatKey];
        return flat ? 'Text To Audio : ' + flat : fallback;
      };
      var resolveIcon = function resolveIcon(iconKey) {
        var _window0, _window1;
        return ((_window0 = window) === null || _window0 === void 0 || (_window0 = _window0.ttsObj) === null || _window0 === void 0 || (_window0 = _window0.player_customizations) === null || _window0 === void 0 || (_window0 = _window0[playerId]) === null || _window0 === void 0 ? void 0 : _window0[iconKey]) || ((_window1 = window) === null || _window1 === void 0 || (_window1 = _window1.ttsObj) === null || _window1 === void 0 || (_window1 = _window1.player_customizations) === null || _window1 === void 0 || (_window1 = _window1[1]) === null || _window1 === void 0 ? void 0 : _window1[iconKey]) || null;
      };
