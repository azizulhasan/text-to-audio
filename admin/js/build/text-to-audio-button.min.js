  ...
  _createClass(TextToSpeech, [{
    ...
    value: function speak(speech) {
      ...
      speech.speak({
        ...
        if (!_this.speech.speaking()) {
          console.log('End utterance ' + _this.speech.speaking());
          _this.listenStatus = 'listen';
          _this.displayButtonText(_this.listenStatus);

          // set up initial content to replacy.
          _this.content = window.ttsContent;
          _this.splittedSentances = (0,_tts_utilities_js__WEBPACK_IMPORTED_MODULE_2__.splitSentences)(window.ttsContent);
          speech.cancel();
        }
        console.log("Success !", data);
        if (_this.callBackAfterEnd) _this.callBackAfterEnd();
        if (!_this.browser.isAndroid()) {
          clearTimeout(_this.timer);
          _this.timer = null;
          clearTimeout(_this.shouldCancelTimer);
          _this.shouldCancelTimer = null;
        }
...
var timerDashboar;
timerDashboar = setTimeout(function () {
