 ...
 */
if ((_window9 = window) !== null && _window9 !== void 0 && (_window9 = _window9.ttsObj) !== null && _window9 !== void 0 && _window9.is_pro_active) {
    ...
    value: function _prepareSpeakButton(speech) {
      ...
      document.addEventListener("visibilitychange", function () {
        ...
        if ('visible' === document.visibilityState && _this4.listenStatus === 'resume') {
          var _window$TTS$settings$, _window;
          var isPausedByIntention = JSON.parse(window.sessionStorage.getItem('tts_paused_by_intention'));
          var stop_autoplay = (_window$TTS$settings$ = (_window = window) === null || _window === void 0 || (_window = _window.TTS) === null || _window === void 0 || (_window = _window.settings) === null || _window === void 0 || (_window = _window.settings) === null || _window === void 0 || (_window = _window.settings) === null || _window === void 0 ? void 0 : _window.tta__settings_stop_auto_playing_after_switching_tab) !== null && _window$TTS$settings$ !== void 0 ? _window$TTS$settings$ : false;
...
if ((_window2 = window) !== null && _window2 !== void 0 && (_window2 = _window2.ttsObj) !== null && _window2 !== void 0 && _window2.is_pro_active) {
...
var getButtonContent = function getButtonContent(buttonId, cssClass, isProLicenseActive) {
  var _window$ttsObj$button, _window, _window2;
  ...
  if ((_window2 = window) !== null && _window2 !== void 0 && (_window2 = _window2.ttsObj) !== null && _window2 !== void 0 && (_window2 = _window2.player_customizations) !== null && _window2 !== void 0 && (_window2 = _window2[1]) !== null && _window2 !== void 0 && _window2.play) {
    var _ttsObj;
    var parser = new DOMParser();
    // convert html string into DOM
    ...
    var icon = "<button id=\"tts__listent_content_".concat(buttonId, "\" class=\"tts__listent_content  ").concat(cssClass, "\" type=\"button\" title=\"Text To Audio:  Tap to listen post.\"><div className=\"tts_button\">").concat(document.documentElement.outerHTML, "</div> <span>");
    return icon + ' ' + buttonText + '<span></span></span></div>';
  }
  return "<button id=\"tts__listent_content_".concat(buttonId, "\" class=\"tts__listent_content  ").concat(cssClass, "\" type=\"button\" title=\"Text To Audio:  Tap to listen post.\"><div class=\"tts_button\"><span class=\"dashicons dashicons-controls-play\"></span><span>").concat(buttonText, "<span></div> </button>");
};
