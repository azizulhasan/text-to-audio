...
var TextToSpeech = /*#__PURE__*/function () {
  ...
  return _createClass(TextToSpeech, [{
    ...
    value: function playButtonContent() {
      ...
      if ((_ttsObj2 = ttsObj) !== null && _ttsObj2 !== void 0 && (_ttsObj2 = _ttsObj2.player_customizations) !== null && _ttsObj2 !== void 0 && (_ttsObj2 = _ttsObj2[1]) !== null && _ttsObj2 !== void 0 && _ttsObj2.play) {
        var _ttsObj3;
        var parser = new DOMParser();
        // convert html string into DOM
        var _document = parser.parseFromString((_ttsObj3 = ttsObj) === null || _ttsObj3 === void 0 || (_ttsObj3 = _ttsObj3.player_customizations) === null || _ttsObj3 === void 0 || (_ttsObj3 = _ttsObj3[1]) === null || _ttsObj3 === void 0 ? void 0 : _ttsObj3.play, "image/svg+xml");
        icon = "<div className=\"tts_button\">".concat(_document.documentElement.outerHTML, "</div><span>");
      }
    ...
    value: function replayButtonContent() {
      ...
      if ((_ttsObj4 = ttsObj) !== null && _ttsObj4 !== void 0 && (_ttsObj4 = _ttsObj4.player_customizations) !== null && _ttsObj4 !== void 0 && (_ttsObj4 = _ttsObj4[1]) !== null && _ttsObj4 !== void 0 && _ttsObj4.replay) {
        var _ttsObj5;
        var parser = new DOMParser();
        // convert html string into DOM
        var _document2 = parser.parseFromString((_ttsObj5 = ttsObj) === null || _ttsObj5 === void 0 || (_ttsObj5 = _ttsObj5.player_customizations) === null || _ttsObj5 === void 0 || (_ttsObj5 = _ttsObj5[1]) === null || _ttsObj5 === void 0 ? void 0 : _ttsObj5.replay, "image/svg+xml");
        icon = "<div className=\"tts_button\">".concat(_document2.documentElement.outerHTML, "</div><span>");
      }
    ...
    value: function pauseButtonContent() {
      ...
      if ((_ttsObj6 = ttsObj) !== null && _ttsObj6 !== void 0 && (_ttsObj6 = _ttsObj6.player_customizations) !== null && _ttsObj6 !== void 0 && (_ttsObj6 = _ttsObj6[1]) !== null && _ttsObj6 !== void 0 && _ttsObj6.pause) {
        var _ttsObj7;
        var parser = new DOMParser();
        // convert html string into DOM
        var _document3 = parser.parseFromString((_ttsObj7 = ttsObj) === null || _ttsObj7 === void 0 || (_ttsObj7 = _ttsObj7.player_customizations) === null || _ttsObj7 === void 0 || (_ttsObj7 = _ttsObj7[1]) === null || _ttsObj7 === void 0 ? void 0 : _ttsObj7.pause, "image/svg+xml");
        icon = "<div className=\"tts_button\">".concat(_document3.documentElement.outerHTML, "</div><span>");
      }
    ...
    value: function resumeButtonContent() {
      var _ttsObj8;
      var icon = '<div class="tts_button"><span class="dashicons dashicons-controls-play"></span> <span>';
      if ((_ttsObj8 = ttsObj) !== null && _ttsObj8 !== void 0 && (_ttsObj8 = _ttsObj8.player_customizations) !== null && _ttsObj8 !== void 0 && (_ttsObj8 = _ttsObj8[1]) !== null && _ttsObj8 !== void 0 && _ttsObj8.resume) {
        var _ttsObj9;
        var parser = new DOMParser();
        // convert html string into DOM
        var _document4 = parser.parseFromString((_ttsObj9 = ttsObj) === null || _ttsObj9 === void 0 || (_ttsObj9 = _ttsObj9.player_customizations) === null || _ttsObj9 === void 0 || (_ttsObj9 = _ttsObj9[1]) === null || _ttsObj9 === void 0 ? void 0 : _ttsObj9.resume, "image/svg+xml");
        icon = "<div className=\"tts_button\">".concat(_document4.documentElement.outerHTML, "</div><span>");
      }
