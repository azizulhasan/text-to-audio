    ...
    value: function _prepareSpeakButton(speech) {
      ...
      document.addEventListener("visibilitychange", function () {
        ...
        if ('visible' === document.visibilityState && _this4.listenStatus === 'resume' && stop_autopause) {
          var _ttsObj$settings$tta_, _ttsObj10;
          var isPausedByIntention = JSON.parse(window.sessionStorage.getItem('tts_paused_by_intention'));
          var stop_autoplay = (_ttsObj$settings$tta_ = (_ttsObj10 = ttsObj) === null || _ttsObj10 === void 0 || (_ttsObj10 = _ttsObj10.settings) === null || _ttsObj10 === void 0 ? void 0 : _ttsObj10.tta__settings_stop_auto_playing_after_switching_tab) !== null && _ttsObj$settings$tta_ !== void 0 ? _ttsObj$settings$tta_ : false;
