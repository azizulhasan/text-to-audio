...
var getButtonContent = function getButtonContent(buttonId, cssClass, isProLicenseActive) {
  ...
  return "<button id=\"tts__listent_content_".concat(buttonId, "\" class=\"tts__listent_content  ").concat(cssClass, "\" type=\"button\" title=\"Text To Audio:  Tap to listen post.\"><div class=\"tts_button\"><span class=\"dashicons dashicons-controls-play\"></span><span>").concat(ttsObj.buttonTextArr.listen_text, "<span></div> </button>");
};
