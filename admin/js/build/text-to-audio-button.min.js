...
function _country() {
  ...
  var tzData = ct.getTimezone(timeZone);
      ...
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return fetch("".concat(ttsObj.api_url).concat(ttsObj.api_namespace, "/").concat(ttsObj.api_version, "/geolocation"), {
            ...
            headers: {
              'Content-Type': 'application/json',
              'X-WP-NONCE': ((_window10 = window) === null || _window10 === void 0 || (_window10 = _window10.ttsObj) === null || _window10 === void 0 ? void 0 : _window10.rest_nonce) || ''
            }
          });
        case 3:
...
var TTSPlayButton = /*#__PURE__*/function (_HTMLElement) {
  function TTSPlayButton() {
    ...
    _this = _callSuper(this, TTSPlayButton);
    _classPrivateMethodInitSpec(_this, _TTSPlayButton_brand);
    _defineProperty(_this, "speech", null);
    _defineProperty(_this, "isProLicenseActive", false);
    _defineProperty(_this, "analytics", null);
    if (typeof NoSleep === 'function' && (_ttsObj = ttsObj) !== null && _ttsObj !== void 0 && _ttsObj.is_mobile) {
      var noSleep = new NoSleep();
      window.onload = function () {
        noSleep.enable();
    ...
    _this.isProLicenseActive = (_window = window) === null || _window === void 0 || (_window = _window.ttsObj) === null || _window === void 0 ? void 0 : _window.is_pro_active;
    ...
    if (window.hasOwnProperty('TTS')) {
      ...
      _this.analytics = new _AtlasVoiceAnalytics__WEBPACK_IMPORTED_MODULE_2__["default"](window.TTS.settings.postId); // Render all buttons in page have.
      var _loop = function _loop() {
        var buttonId = _buttonIds[_i];
        if (buttonId == _this.getAttribute('data-id')) {
          var _ttsObj2, _ttsObj3;
          // Create div
          var wrapper = document.createElement('div');
          wrapper.setAttribute('class', 'wrapper');
          wrapper.innerHTML = (0,_tts_utilities_js__WEBPACK_IMPORTED_MODULE_1__.getButtonContent)(buttonId, settings.cssClass, _this.isProLicenseActive);
          _this.analytics.trackInit();
          ...
          if (settings !== null && settings !== void 0 && settings.customCSS) {
            style.textContent += "\n                            ".concat(_assertClassBrand(_TTSPlayButton_brand, _this, _htmlDecode).call(_this, settings.customCSS), "\n                        ");
          }
