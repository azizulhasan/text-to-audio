...
> * [AI Workflow Automation â€“ MCP ](https://wordpress.org/plugins/ai-workflow-automation-ai-agent-hub/) â€“ AI-powered WordPress hub with 80+ abilities, built-in MCP server, role-based access control, JWT auth, workflow builder, and WooCommerce support.
> * [Smart Local AI â€“ Browser-Based Private AI Tools ](https://wordpress.org/plugins/smart-local-ai/) â€“ Privacy-first browser ML suite. Client-side AI for content recommendations, personalized suggestions, and image alt text â€” no cloud APIs needed.
