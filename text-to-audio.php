...
if (TTA_DEBUG_MODE && (defined('WP_SITEURL') || get_option('siteurl'))) {
    $rest_url = (defined('WP_SITEURL') ? WP_SITEURL : get_option('siteurl')) . '/wp-json/';
...
class TTA_Init
{
    ...
    public function __construct()
    {
        if (!defined('TEXT_TO_AUDIO_VERSION')) {
            define('TEXT_TO_AUDIO_VERSION', apply_filters('tts_version', ' 2.1.5'));
        }
