...
var TTA = {
  ...
  speak: function speak(speech) {
    ...
    speech.speak({
      ...
      queue: false,
      listeners: {
        onstart: function onstart(utterance) {// console.log("Start utterance");
        },
        onend: function onend(utterance) {//console.log('End utterance');
        },
        ...
        onboundary: function onboundary(utterance) {// console.log(
          // 	utterance.name +
