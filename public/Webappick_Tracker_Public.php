<?php
namespace WebappickTracker_Public;
/**
 ...
 * @subpackage Webappick_Tracker/public
 */
 ...
 */
class Webappick_Tracker_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/webappick-tracker-public.css', array(), $this->version, 'all' );
